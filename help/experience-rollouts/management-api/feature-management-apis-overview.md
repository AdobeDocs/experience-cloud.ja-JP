...
* [機能グループ管理API](feature-group-management-api.md) – 機能グループを作成、読み取り、更新、削除します。
...
* **GET Feature API V3**&#x200B;および&#x200B;**GET Feature API V2** – 完全な参照情報については、このガイドのFeature API セクションを参照してください。
